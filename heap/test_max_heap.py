...
class HeapTests(unittest.TestCase):
  ...
  def test_heap_insert_works(self):
    self.heap.insert(6)
    print("6: ", self.heap.storage)
    self.heap.insert(8)
    print("8: ", self.heap.storage)
    self.heap.insert(10)
    print("10: ", self.heap.storage)
    self.heap.insert(9)
    print("9: ", self.heap.storage)
    self.heap.insert(1)
    print("1: ", self.heap.storage)
    self.heap.insert(9)
    self.heap.insert(9)
    self.heap.insert(5) 
